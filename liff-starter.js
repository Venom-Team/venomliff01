    ...
    if (type=== "text") {
        ...
        if (send===null){
            ...
            if(send===true || send==="true")
                if(tp==="a"){
                    uriz="line://app/1621270896-Ge9WDqaW/?type=sticker&tstk=animasi&stkid="+sid+"&stkpkgid="+pkg+"&send=true";
                }else{
                    uriz="line://app/1621270896-Ge9WDqaW/?type=sticker&tstk=anime&stkid="+sid+"&stkpkgid="+pkg+"&send=true";
                }
        }
        liff.sendMessages([{
          type: "template",
